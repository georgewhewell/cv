...
\item Supported YouTube \textit{Carnaval} Project in Salvador, Brazil by coordinating work with London team and implementing post-launch adjustments. Scaled from 0 to >400k concurrents in minutes
...
\item Coordinated with internal Google teams to build a prototype 3D-scanning application using Tornado
