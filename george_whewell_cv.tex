...
\item Develop custom library for Beyond Digital agency for use in CMS projects sharing common requirements, providing security and functionality out-of-the-box. (3 Months, Python, Django, App Engine)
...
\item Developed and deployed custom CRM for UK media group handing billions of
