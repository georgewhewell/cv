...
\item Assist AIG Science Team in extending existing single-market product to 3 new regions, using combination of web scraping and RESTful/SOAP APIs. (3 months, Python)
\item Go-live prep for dot-com build at Dare agency (4 weeks, full-stack, Django)
...
{\sl Open Source}
\item I am contributing member of the Linux distro NixOS, responsible for maintaining several packages have created a re-spin specifically for embedded hardware which I develop and maintain.
