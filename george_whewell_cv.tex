...
\begin{itemize} \itemsep -1pt
\item Built and supported various YouTube microsites using Flask on Google App Engine, conforming with rigorous security, performance and functionality requirements (Python, Flask, App Engine)
